Install:
	[en]:
		1. Move patch-X.mpq file to the Data folder
		2. Move pretty_patchkit file to the AddOns folder
		3. Disable GearScore addon if you have this
		4. Addon settings are in Interface - AddOns - patch kit
...
FAQ:
	[en]:
		Q. Error "Your game interface files are corrupt."
...
support me with donation / поддержать меня материально
https://boosty.to/s0high

Copyright (c) 2022 s0high
